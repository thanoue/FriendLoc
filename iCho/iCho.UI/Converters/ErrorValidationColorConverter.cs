...
using iCho.UI.Controls;
using iCho.UI.ViewModels.Forms;

namespace iCho.UI.Converters
{
    /// <summary>
    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                emailEntry.IsValid = isFocused || CheckValidEmail(emailEntry.Text);
                ...
                return !emailEntry.IsValid ? Color.FromHex("#FF4A4A") : Color.Transparent;
